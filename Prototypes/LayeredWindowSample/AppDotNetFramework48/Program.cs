...
namespace AppDotNetFramework48
{
    public partial class MainForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "Layered Window Sample - .NET Framework 4.8";
        ...
        private void LoadSampleImage()
        {
            ...
            {
                MessageBox.Show(string.Format("画像の読み込みに失敗しました: {0}", ex.Message), "エラー", MessageBoxButtons.OK, MessageBoxIcon.Error);
                CreateFallbackImage();
            }
        }
