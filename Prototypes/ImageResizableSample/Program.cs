...
namespace ImageResizableSample
{
    internal static class Program
    {
        ...
        static void Main()
        {
            ...
            app.Run();
#else
            Console.WriteLine("ImageResizableSample - .NET 8");
            Console.WriteLine("このアプリケーションはWindows環境でのみ動作します。");
            Console.WriteLine("Windows環境で実行すると、通常のウィンドウと透明背景のウィンドウを");
            Console.WriteLine("クリックによって切り替えることができ、マウスホイールで画像を拡大縮小");
            Console.WriteLine("できるサンプルが表示されます。");
            Console.WriteLine();
            Console.WriteLine("機能:");
            Console.WriteLine("- クリックで通常ウィンドウ ⇔ 透明ウィンドウの切り替え");
            Console.WriteLine("- マウスホイールによる画像の拡大・縮小");
            Console.WriteLine("- Ctrl + 0 キーで100%表示に戻す");
            Console.WriteLine("- 枠ありウィンドウでの画像スクロール対応");
